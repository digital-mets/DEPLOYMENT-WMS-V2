    ...
    ASPxClientUtils.AttachEventToElement(s.GetMainElement(), "keydown", function (event) {
       ...
       function OnUpdateClick(s, e) { //Add/Edit/Close button function
           ...
           if (isValid && counterror < 1 || btnmode == "Close") { //check if there's no error then proceed to callback
               ...
               if (txtClient.GetValue() == null || txtClient.GetValue().replace(/\s/g, '') == '') {
                   counterror = 0;
                                           ...
                                           <dx:LayoutItem Caption="Warehouse Code:" Name="WarehouseCode">
                                            ...
                                            <dx:LayoutItem Caption="Document Date:" Name="DocDate" ColSpan="1">
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                 ...
                                                 <dx:LayoutItem Caption="Client:" Name="Client" >
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                                            <dx:ASPxTextBox ID="txtClient"  ClientInstanceName="txtClient" runat="server" Width="170px">
                                                                <ValidationSettings Display="None" ValidateOnLeave="true" ErrorDisplayMode="ImageWithTooltip" >
                                                                <RequiredField IsRequired="True"/>
                                                            </ValidationSettings>
                                                            <InvalidStyle BackColor="Pink">
...
<SettingsBehavior AllowSort="False"></SettingsBehavior>
                                                    ...
                                                    <Columns>
                                                           ...
                                                           <dx:GridViewDataTextColumn FieldName="ItemDescription" Caption="Description" VisibleIndex="4" Width="250px" Name="glItemCode">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="PalletID" VisibleIndex="5" Width="120px" Caption="PalletID">
                                                            </dx:GridViewDataTextColumn>
                                                          <dx:GridViewDataTextColumn FieldName="ToPalletID" VisibleIndex="5" Width="0px" Caption="To PalletID" PropertiesTextEdit-ClientSideEvents-Init="InitTrans">
                                                          </dx:GridViewDataTextColumn>    
                                                          <dx:GridViewDataTextColumn FieldName="FromLoc" VisibleIndex="5" Width="120px" Name="FromLoc"  Caption="Location">
                                                        </dx:GridViewDataTextColumn>
     
                                                                 <dx:GridViewDataTextColumn FieldName="ToLoc" VisibleIndex="5" Width="0px" Name="ToLoc">
                                                             <EditItemTemplate>
...
<CellStyle BackColor="#99ccff"></CellStyle>
                                                      ...
                                                      <dx:GridViewDataSpinEditColumn Caption="Current Kilo" FieldName="CurrentQty" Name="CurrentQty" ShowInCustomizationForm="True" VisibleIndex="10">
                                                      ...
                                                      <dx:GridViewDataSpinEditColumn  Caption="Reserved Kilo" FieldName="TargetQty" Name="TargetQty" ShowInCustomizationForm="True" VisibleIndex="11" CellStyle-BackColor="#99ccff">
...
<CellStyle BackColor="#99ccff"></CellStyle>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="BulkUnit" VisibleIndex="14" Name="BulkUnit">
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Lot" FieldName="LotNumber" Name="Lot" Width="200px" ShowInCustomizationForm="True" VisibleIndex="15">
                                                        </dx:GridViewDataTextColumn>
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn FieldName="DocNumber" Visible="False"
                                                          ...
                                                          <dx:GridViewDataTextColumn FieldName="FromLoc" VisibleIndex="5" Width="120px" Name="FromLoc" Caption="Location">
                                                                 ...
                                                                 <dx:GridViewDataTextColumn FieldName="ToLoc" VisibleIndex="9" Width="0px" Name="ToLoc">
                                                             <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="ToLoc" runat="server" AutoGenerateColumns="True" AutoPostBack="false"  OnInit="gl6_Init"
                                                                    DataSourceID="ToLocation" KeyFieldName="LocationCode" ClientInstanceName="gl6" TextFormatString="{0}" Width="80px" OnLoad="gvLookupLoad" >
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="BulkQty" VisibleIndex="9" Width="120px" Caption="Reserved Bulk Qty">
                                                                <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                                    ClientInstanceName="gBulkQty" MinValue="0">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="BatchNumber" Name="BatchNumber" ShowInCustomizationForm="True" VisibleIndex="15">
                                                          ...
                                                          <dx:GridViewDataTextColumn  Caption="Lot" FieldName="LotNumber" Name="Lot" ShowInCustomizationForm="True" VisibleIndex="15">
                                                        </dx:GridViewDataTextColumn>
...
'' ExpiryDate,'' BatchNo,'' as LotNumber,'' as RRDate	 FROM  WMS.ItemAdjustmentDetail where Docnumber  is null " OnInit = "Connection_Init">
    </asp:SqlDataSource>
