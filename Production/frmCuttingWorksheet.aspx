...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function autocalculate(s, e) {
            ...
            setTimeout(function () {
                ...
                var indicies1 = gvusedfabric.batchEditApi.GetRowVisibleIndices();
                ...
                for (var i = 0; i < indicies1.length; i++) {
                    if (gvusedfabric.batchEditApi.IsNewRow(indicies1[i])) {
                        ...
                        if (gvusedfabric.batchEditApi.IsDeletedRow(key))
